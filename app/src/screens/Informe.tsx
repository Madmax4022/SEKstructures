...
import { contarFotos, emitirInforme, listarHallazgos, listarNoEvaluados, obtenerPerfil } from '../lib/data';
...
export default function Informe({ proyecto, modulo, inspeccionId, onVolver }: Props) {
  ...
  useEffect(() => {
    ...
    listarNoEvaluados(inspeccionId).then((u) => setUnev(u.length)).catch(() => {});
    ...
    <>
      ...
      <div className="content">
        ...
        <div className="card">
          ...
          <div className="row" style={{ justifyContent: 'space-between', marginTop: 8 }}><span className="muted">Elementos no evaluados</span><b className="kv">{unev}</b></div>
        ...
        <div className="btnbar">
          <button className="btn ghost" onClick={descargarMatriz} disabled={total === 0}>
            ⇩ Descargar matriz de seguimiento (CSV)
          </button>
